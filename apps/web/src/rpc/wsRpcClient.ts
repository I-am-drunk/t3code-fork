import {
  ...
  type LocalApi,
  type VibecodePreviewStatusInput,
  type VibecodeRotateApiKeyInput,
  type VibecodeRuntimeStatusInput,
...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly vibecodeAuthStatus: RpcUnaryNoArgMethod<typeof WS_METHODS.vibecodeAuthStatus>;
    readonly vibecodeRotateApiKey: (
      input: VibecodeRotateApiKeyInput,
    ) => ReturnType<RpcUnaryMethod<typeof WS_METHODS.vibecodeRotateApiKey>>;
    readonly vibecodeRuntimeStatus: (
      input: VibecodeRuntimeStatusInput,
    ) => ReturnType<RpcUnaryMethod<typeof WS_METHODS.vibecodeRuntimeStatus>>;
    readonly vibecodePreviewStatus: (
      input: VibecodePreviewStatusInput,
    ) => ReturnType<RpcUnaryMethod<typeof WS_METHODS.vibecodePreviewStatus>>;
    readonly vibecodePreviewOpen: (
      input: VibecodePreviewStatusInput,
    ) => ReturnType<RpcUnaryMethod<typeof WS_METHODS.vibecodePreviewOpen>>;
    readonly vibecodeSyncStatus: (
      input: VibecodeRuntimeStatusInput,
    ) => ReturnType<RpcUnaryMethod<typeof WS_METHODS.vibecodeSyncStatus>>;
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    server: {
      ...
      vibecodeAuthStatus: () =>
        transport.request((client) =>
          client[WS_METHODS.vibecodeAuthStatus]({}).pipe(Effect.withTracerEnabled(false)),
        ),
      vibecodeRotateApiKey: (input) =>
        transport.request((client) =>
          client[WS_METHODS.vibecodeRotateApiKey](input).pipe(Effect.withTracerEnabled(false)),
        ),
      vibecodeRuntimeStatus: (input) =>
        transport.request((client) =>
          client[WS_METHODS.vibecodeRuntimeStatus](input).pipe(Effect.withTracerEnabled(false)),
        ),
      vibecodePreviewStatus: (input) =>
        transport.request((client) =>
          client[WS_METHODS.vibecodePreviewStatus](input).pipe(Effect.withTracerEnabled(false)),
        ),
      vibecodePreviewOpen: (input) =>
        transport.request((client) =>
          client[WS_METHODS.vibecodePreviewOpen](input).pipe(Effect.withTracerEnabled(false)),
        ),
      vibecodeSyncStatus: (input) =>
        transport.request((client) =>
          client[WS_METHODS.vibecodeSyncStatus](input).pipe(Effect.withTracerEnabled(false)),
        ),
