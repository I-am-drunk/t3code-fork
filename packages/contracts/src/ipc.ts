...
export interface LocalApi {
  ...
  server: {
    ...
    vibecodeAuthStatus: () => Promise<VibecodeAuthStatusResult>;
    vibecodeRotateApiKey: (input: VibecodeRotateApiKeyInput) => Promise<VibecodeRotateApiKeyResult>;
    vibecodeRuntimeStatus: (input: VibecodeRuntimeStatusInput) => Promise<VibecodeRuntimeStatus>;
    vibecodePreviewStatus: (input: VibecodePreviewStatusInput) => Promise<VibecodePreviewStatus>;
    vibecodePreviewOpen: (input: VibecodePreviewStatusInput) => Promise<VibecodeOpenPreviewResult>;
    vibecodeSyncStatus: (input: VibecodeRuntimeStatusInput) => Promise<VibecodeSyncStatus>;
  };
}
