...
export const VibecodeSettings = makeProviderSettingsSchema(
  {
    enabled: Schema.Boolean.pipe(
      Schema.withDecodingDefault(Effect.succeed(true)),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ...
    apiBaseUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "API base URL",
        description: "Leave blank for the hosted Vibecode API.",
        providerSettingsForm: {
          placeholder: "https://api.vibecode.com",
          clearWhenEmpty: "omit",
        },
      }),
    ),
    projectId: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "Vibecode project ID",
        description:
          "Optional. When set, T3 Code acquires this Vibecode project's sandbox before sending turns.",
        providerSettingsForm: {
          placeholder: "abc123",
          clearWhenEmpty: "omit",
        },
    ...
    agentUrl: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "Direct agent URL",
        description:
          "Optional. Use for local testing or a known sandbox agent URL. Project sandbox acquisition is skipped when set.",
        providerSettingsForm: {
  ...
  {
    order: ["apiBaseUrl", "projectId", "agentUrl"],
  },
);
export type VibecodeSettings = typeof VibecodeSettings.Type;
...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    vibecode: VibecodeSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
  }).pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
const VibecodeSettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      vibecode: Schema.optionalKey(VibecodeSettingsPatch),
    }),
  ),
